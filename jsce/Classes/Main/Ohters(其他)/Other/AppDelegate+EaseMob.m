...
#warning SDK注册 APNS文件的名字, 需要与后台上传证书时的名字一一对应
    ...
    apnsCertName = @"SupportPushCertificates";
    
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"yuantuinfo#jsce"
                       ...
                       message:(NSString *)message
{
    ...
    [[MMApplyFriendViewController  shareController] addNewApply:dic];
...
- (void)didConnectionStateChanged:(EMConnectionState)connectionState
{
    ...
    [self.jsceTBC networkChanged:connectionState];
}
